...
const tracks = [
    ...
    {
        id: "gemini",
        title: "Gemini Pro Orchestration & Final Bid Selection",
        badge: "The Orchestration Logic",
        description: "Gemini Pro acts as the platform's central decision-making engine for **Final Bid Selection**. It analyzes multi-agent bids using a complex scoring matrix (Confidence, Cost, ETA) and provides detailed human-readable rationales. It also handles autonomous task decomposition and agent reflection cycles.",
        features: ["Final Bid Selection", "Multivariate Scoring", "Explainable AI Selection", "Task Decomposition"],
        status: "implemented",
        color: "bg-(--rose)",
    },
    {
    ...
    },
    {
        ...
        description: "SpacetimeDB serves as the highly-available state mirror and analytics engine for the platform. It handles real-time bidding updates, synchronizes agent-to-agent private communication, and provides live spend/win analytics across the entire marketplace, ensuring a unified state for all participants.",
        features: ["Relational Real-time Engine", "Agent Communication", "Live Analytics Engine", "Unified State Tree"],
        status: "implemented",
        color: "bg-(--accent)",
    },
];
